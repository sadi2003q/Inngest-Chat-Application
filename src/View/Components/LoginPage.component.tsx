    ...
    return (
        <header className="bg-white border-b border-[#F9FAFB] py-5">
            <div className="max-w-[1200px] mx-auto px-6 flex justify-between items-center">
                <a href="/" className="text-2xl font-bold text-[#101828] tracking-tight">ChatNow</a>
                <a href="/login" className="text-sm hover:text-[#101828] transition-colors">
                    Already have an account? <span className="text-[#FF5A1F] font-semibold ml-2">Sign in</span>
                </a>
            </div>
        </header>
    )
...
export const TermsAndConditions = () => {
    return (
        <div className="flex items-start gap-3">
            <input type="checkbox" id="terms" className="mt-1 w-4 h-4 accent-[#FF5A1F]" required onChange={handleInputChange} />
            <label htmlFor="terms" className="text-sm leading-relaxed">
                I agree to the <a href="#" className="text-[#FF5A1F] font-medium">Terms of Service</a> and <a href="#" className="text-[#FF5A1F] font-medium">Privacy Policy</a>
            </label>
        </div>
    );
}
