    ...
    return (
        <header className="bg-white border-b border-[#F9FAFB] py-5">
            <div className="max-w-[1200px] mx-auto px-6 flex justify-between items-center">
                <Link to="/signup" className="text-2xl font-bold text-[#101828] tracking-tight hover:opacity-80 transition-opacity">
                    ChatNow
                </Link>
                <Link to="/signup" className="text-sm text-[#475467] hover:text-[#101828] transition-colors">
...
export const SignUp_Link = () => {
    return (
        <div className="text-center mt-8 text-sm text-[#475467]">
            Don't have an account? <Link to="/signup" className="text-[#FF5A1F] font-semibold hover:text-[#D94816] transition-colors">Sign up for free</Link>
        </div>
    );
}